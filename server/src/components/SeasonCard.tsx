    ...
    <div className="w-full max-w-sm rounded-2xl border border-border bg-card p-4 shadow-sm transition-colors duration-200 hover:bg-accent">
      <div className="relative overflow-hidden rounded-xl border border-border">
        ...
        <div className="absolute top-3 right-3">
          <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(season.status)} text-white shadow`}
          >
      ...
      <div className="mt-3">
        ...
        <div className="mt-3 grid grid-cols-3 gap-3 text-xs text-muted-foreground">
          <div>
            <div className="text-[11px] uppercase tracking-wide text-muted-foreground/80">Prize pool</div>
            <div className="text-sm font-medium text-foreground">{season.prize_pool_label ?? "TBD"}</div>
          </div>
          <div>
            <div className="text-[11px] uppercase tracking-wide text-muted-foreground/80">Judges</div>
            <div className="text-sm font-medium text-foreground">{season.judges_count}</div>
          </div>
          <div>
            <div className="text-[11px] uppercase tracking-wide text-muted-foreground/80">Auditions</div>
            <div className="text-sm font-medium text-foreground">{season.auditions_count} agents</div>
          </div>
        </div>
