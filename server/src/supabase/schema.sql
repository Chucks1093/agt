...
create table if not exists public.seasons (
  ...
  prize_pool_agt numeric not null default 0,
  prize_pool_usdc numeric not null default 0,
  sponsors jsonb not null default '[]'::jsonb,
  episode_2_participants int not null default 0,
  total_auditions int not null default 0,
  total_judges int not null default 0,
  accepted_agents int not null default 0,
